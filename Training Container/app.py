...
def main():
    ...
    parser.add_argument('--num_of_models', type=int, default=3, help='Number of models to generate.')
    parser.add_argument('--epochs', type=int, default=50, help='Number of epochs per training loop.')
    parser.add_argument('--batch_size', type=int, default=24, help='Batch size for training.')
    parser.add_argument('--remaining_tries', type=int, default=5, help='Maximum training attempts.')
    parser.add_argument('--num_of_layers', type=int, default=7, help='Maximum training attempts.')
    parser.add_argument('--acceptable_acc_score', type=float, default=0.6, help='Minimum required accuracy.')
